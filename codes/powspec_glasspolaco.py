...
for i in ['001','002','003','004','005','006','007','008','009','010']:
    ...
    dcat = CSVCatalog('/home/fdavila/Proyectos/Multipoles/data/glass/glass_{}.dat'.format(i),names=['x','y','z'])
...
plt.loglog(kt,(10**(17.5)/(float(dcat.size))**2.32)*kt**4,c=c,ls='-.',label=r'$P(k)\alpha k^4$') 
