...
for id_r in range(len(nr)):
    ...
    #for nran in [87**3]:
        ...
        if nran==87**3:
            print('zelrec0: ',zelrec0)
            print('xi_0var_zelrec[{}]: '.format(id_r),xi_0var_zelrec[id_r])
            print('xi_0var_zelrec: ',xi_0var_zelrec)
    ...
    f.tight_layout()
    f.savefig('../plots/VariancesOld/variances_{}.png'.format(id_r),dpi=f.dpi)
    #plt.show()
    plt.close()
    #-----------------------------------------------------
