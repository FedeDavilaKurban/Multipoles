...
#######################################################################
#Ran
ran_1 = ascii.read('../../data/out/mean_xi/mean_ran_{}.txt'.format(87**3))
ran_2 = ascii.read('../../data/out/mean_xi/mean_ran_{}.txt'.format(2*87**3))
ran_4 = ascii.read('../../data/out/mean_xi/mean_ran_{}.txt'.format(4*87**3))
ran_8 = ascii.read('../../data/out/mean_xi/mean_ran_{}.txt'.format(8*87**3))

#RanCross
rc_1 = ascii.read('../../data/out/mean_xi/mean_rc_{}.txt'.format(87**3))
rc_2 = ascii.read('../../data/out/mean_xi/mean_rc_{}.txt'.format(2*87**3))
rc_4 = ascii.read('../../data/out/mean_xi/mean_rc_{}.txt'.format(4*87**3))
rc_8 = ascii.read('../../data/out/mean_xi/mean_rc_{}.txt'.format(8*87**3))

#RanSplit
rs_1 = ascii.read('../../data/out/mean_xi/mean_rs_{}.txt'.format(87**3))
rs_2 = ascii.read('../../data/out/mean_xi/mean_rs_{}.txt'.format(2*87**3))
rs_4 = ascii.read('../../data/out/mean_xi/mean_rs_{}.txt'.format(4*87**3))
rs_8 = ascii.read('../../data/out/mean_xi/mean_rs_{}.txt'.format(8*87**3))

#Glass
g_1 = ascii.read('../../data/out/xi_mean/mean_glass_{}.txt'.format(87**3))
g_2 = ascii.read('../../data/out/xi_mean/mean_glass_{}.txt'.format(2*87**3))
g_4 = ascii.read('../../data/out/xi_mean/mean_glass_{}.txt'.format(4*87**3))
g_8 = ascii.read('../../data/out/xi_mean/mean_glass_{}.txt'.format(8*87**3))

#ZelRec
zr_1 = ascii.read('../../data/out/mean_xi/mean_zr_{}.txt'.format(87**3))
zr_2 = ascii.read('../../data/out/mean_xi/mean_zr_{}.txt'.format(2*87**3))
zr_4 = ascii.read('../../data/out/mean_xi/mean_zr_{}.txt'.format(4*87**3))
zr_8 = ascii.read('../../data/out/mean_xi/mean_zr_{}.txt'.format(8*87**3))
