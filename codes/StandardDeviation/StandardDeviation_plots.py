...
#######################################################################
#Ran
ran_1 = ascii.read('../../data/out/std_xi/std_ran_{}.txt'.format(87**3))
...
rc_2 = ascii.read('../../data/out/std_xi/std_rc_{}.txt'.format(2*87**3))
rc_4 = ascii.read('../../data/out/std_xi/std_rc_{}.txt'.format(4*87**3))
rc_8 = ascii.read('../../data/out/std_xi/std_rc_{}.txt'.format(8*87**3))

#RanSplit
rs_1 = ascii.read('../../data/out/std_xi/std_rs_{}.txt'.format(87**3))
rs_2 = ascii.read('../../data/out/std_xi/std_rs_{}.txt'.format(2*87**3))
rs_4 = ascii.read('../../data/out/std_xi/std_rs_{}.txt'.format(4*87**3))
rs_8 = ascii.read('../../data/out/std_xi/std_rs_{}.txt'.format(8*87**3))

#Glass
g_1 = ascii.read('../../data/out/xi_sd/std_glass_{}.txt'.format(87**3))
g_2 = ascii.read('../../data/out/xi_sd/std_glass_{}.txt'.format(2*87**3))
g_4 = ascii.read('../../data/out/xi_sd/std_glass_{}.txt'.format(4*87**3))
g_8 = ascii.read('../../data/out/xi_sd/std_glass_{}.txt'.format(8*87**3))

#ZelRec
zr_1 = ascii.read('../../data/out/std_xi/std_zr_{}.txt'.format(87**3))
zr_2 = ascii.read('../../data/out/std_xi/std_zr_{}.txt'.format(2*87**3))
zr_4 = ascii.read('../../data/out/std_xi/std_zr_{}.txt'.format(4*87**3))
zr_8 = ascii.read('../../data/out/std_xi/std_zr_{}.txt'.format(8*87**3))

#CCVT
c_1 = ascii.read('../../data/out/std_xi/std_c_{}.txt'.format(87**3))
#######################################################################
...
#for ir in range(1):
	...
	yrc  = [rc_1['xi0'][ir]/ran_1['xi0'][ir] , rc_2['xi0'][ir]/ran_2['xi0'][ir],  rc_4['xi0'][ir]/ran_4['xi0'][ir],  rc_8['xi0'][ir]/ran_8['xi0'][ir]]
	yrs  = [rs_1['xi0'][ir]/ran_1['xi0'][ir] , rs_2['xi0'][ir]/ran_2['xi0'][ir],  rs_4['xi0'][ir]/ran_4['xi0'][ir],  rs_8['xi0'][ir]/ran_8['xi0'][ir]]
	yg   = [g_1['xi0'][ir]/ran_1['xi0'][ir]  , g_2['xi0'][ir]/ran_2['xi0'][ir],   g_4['xi0'][ir]/ran_4['xi0'][ir],   g_8['xi0'][ir]/ran_8['xi0'][ir]]
	yzr  = [zr_1['xi0'][ir]/ran_1['xi0'][ir] , zr_2['xi0'][ir]/ran_2['xi0'][ir],  zr_4['xi0'][ir]/ran_4['xi0'][ir],  zr_8['xi0'][ir]/ran_8['xi0'][ir]]
	yc   = [c_1['xi0'][ir]/ran_1['xi0'][ir]]
	...
	f.tight_layout()
	f.savefig('../../plots/StandardDeviationNorm/stdnorm_{}.png'.format(ir),dpi=f.dpi)
	#plt.show()
	plt.close()
...
for Nran in [87**3,2*87**3,4*87**3,8*87**3]:
	...
	ax3.set_yscale('log')
	ax3.set_xlabel('$N_{ran}$',fontsize=fs)
	ax3.set_ylim(1E-1,9E-1)

	#f.suptitle(r'$R = {}Mpc$'.format(nr[ir]),fontsize=15)
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('../../plots/SNorm_vs_r/snorm_vs_r_{}.png'.format(Nran),dpi=f.dpi)
	#plt.show()
	plt.close()
...
for ir in range(len(nr)):
	...
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('../../plots/StandardDeviation/std_{}.png'.format(ir),dpi=f.dpi)
	#plt.show()
	plt.close()
...
for Nran in [87**3,2*87**3,4*87**3,8*87**3]:
	...
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('../../plots/S_vs_r/s_vs_r_{}.png'.format(Nran),dpi=f.dpi)
	#plt.show()
	plt.close()
