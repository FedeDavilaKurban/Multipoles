...
if nran==87**3:
	for i in range(0,120,2):
		xi_l_ccvt.append( ascii.read('../data/out/ccvt/xi_l_{}_{}.txt'.format(nran,i),names=names))
...
#
#if 0 in mps:
#    plt.errormean(nr,(nr**2)*xi_l['xi_0'],ls='-',color='r',label=r'Analytic')
#if 2 in mps:
#    plt.errormean(nr,(nr**2)*xi_l['xi_2'],ls='-.',color='r',label=r'Analytic')
#if 4 in mps:
#    plt.errormean(nr,(nr**2)*xi_l['xi_4'],ls='--',color='r',label=r'Analytic')
#
#
#if 0 in mps:
#    plt.errormean(nr,(nr**2)*xi_0mean_ran,yerr=(nr**2)*np.array(xi_0var_ran),ls='-',color=seaborn.color_palette()[0],label=r'$\xi_0(r)\, Ran$')
#if 2 in mps:
#    plt.errormean(nr,(nr**2)*(-np.array(xi_2mean_ran)),yerr=(nr**2)*np.array(xi_2var_ran),ls='-.',color=seaborn.color_palette()[0],label=r'$\xi_2(r)\, Ran$')
#if 4 in mps:
#    plt.errormean(nr,(nr**2)*xi_4mean_ran,yerr=(nr**2)*np.array(xi_4var_ran),ls='--',color=seaborn.color_palette()[0],label=r'$\xi_4(r)\, Ran$')
#
#if 0 in mps:
#    plt.errormean(nr,(nr**2)*xi_0mean_rancross,yerr=(nr**2)*np.array(xi_0var_rancross),ls='-',color=seaborn.color_palette()[1],label=r'$\xi_0(r)\, RanCross$')
#if 2 in mps:
#    plt.errormean(nr,(nr**2)*(-np.array(xi_2mean_rancross)),yerr=(nr**2)*np.array(xi_2var_rancross),ls='-.',color=seaborn.color_palette()[1],label=r'$\xi_2(r)\, RanCross$')
#if 4 in mps:
#    plt.errormean(nr,(nr**2)*xi_4mean_rancross,yerr=(nr**2)*np.array(xi_4var_rancross),ls='--',color=seaborn.color_palette()[1],label=r'$\xi_4(r)\, RanCross$')
#
#if 0 in mps:
#    plt.errormean(nr,(nr**2)*xi_0mean_glass,yerr=(nr**2)*np.array(xi_0var_glass),ls='-',color=seaborn.color_palette()[2],label=r'$\xi_0(r)\, Glass$')
#if 2 in mps:
#    plt.errormean(nr,(nr**2)*(-np.array(xi_2mean_glass)),yerr=(nr**2)*np.array(xi_2var_glass),ls='-.',color=seaborn.color_palette()[2],label=r'$\xi_2(r)\, Glass$')
#if 4 in mps:
#    plt.errormean(nr,(nr**2)*xi_4mean_glass,yerr=(nr**2)*np.array(xi_4var_glass),ls='--',color=seaborn.color_palette()[2],label=r'$\xi_4(r)\, Glass$')
...
#RanSplit
if 0 in mps:
    plt.plot(nr,xi_0var_ransplit,label=r'$\sigma_{\xi_0(r)}\, RanSplit$',ls='-',color=seaborn.color_palette()[0])
if 2 in mps:
    plt.plot(nr,xi_2var_ransplit,label=r'$\sigma_{\xi_2(r)}\, RanSplit$',ls='-',color=seaborn.color_palette()[1])
if 4 in mps:
    plt.plot(nr,xi_4var_ransplit,label=r'$\sigma_{\xi_4(r)}\, RanSplit$',ls='-',color=seaborn.color_palette()[2])
...
#ZelRec
if 0 in mps:
    plt.plot(nr,xi_0var_zelrec,label=r'$\sigma_{\xi_0(r)}\, Zel. Rec.$',ls='-.',color=seaborn.color_palette()[0])
if 2 in mps:
    plt.plot(nr,xi_2var_zelrec,label=r'$\sigma_{\xi_2(r)}\, Zel. Rec.$',ls='-.',color=seaborn.color_palette()[1])
if 4 in mps:
    plt.plot(nr,xi_4var_zelrec,label=r'$\sigma_{\xi_4(r)}\, Zel. Rec.$',ls='-.',color=seaborn.color_palette()[2])

#CCVT
if nran==87**3:
	if 0 in mps:
		plt.plot(nr,xi_0var_ccvt,label=r'$\sigma_{\xi_0(r)}\, CCVT$',ls='-.',color=seaborn.color_palette()[0])
	if 2 in mps:
		plt.plot(nr,xi_2var_ccvt,label=r'$\sigma_{\xi_2(r)}\, CCVT$',ls='-.',color=seaborn.color_palette()[1])
	if 4 in mps:
		plt.plot(nr,xi_4var_ccvt,label=r'$\sigma_{\xi_4(r)}\, CCVT$',ls='-.',color=seaborn.color_palette()[2])
