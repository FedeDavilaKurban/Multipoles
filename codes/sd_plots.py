...
#for ir in range(1):
	...
	f.tight_layout()
	f.savefig('/home/fede/Proyectos/Multipoles/plots/StandardDeviationNorm/stdnorm_{}.png'.format(ir),dpi=f.dpi)
	#plt.show()
	plt.close()
...
for Nran in [87**3,2*87**3,4*87**3,8*87**3]:
	...
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('/home/fede/Proyectos/Multipoles/plots/SNorm_vs_r/snorm_vs_r_{}.png'.format(Nran),dpi=f.dpi)
	#plt.show()
	plt.close()
