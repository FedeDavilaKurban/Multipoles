...
zr_1 = ascii.read('../data/out/mean_xi/adaptativeNbins/mean_zelrec_{}_Niter{}.txt'.format(2*87**3,Niter))
zr_2 = ascii.read('../data/out/mean_xi/adaptativeNbins/mean_zelrec_{}_Niter{}.txt'.format(4*87**3,Niter))
zr_4 = ascii.read('../data/out/mean_xi/adaptativeNbins/mean_zelrec_{}_Niter{}.txt'.format(8*87**3,Niter))
zr_8 = ascii.read('../data/out/mean_xi/adaptativeNbins/mean_zelrec_{}_Niter{}.txt'.format(16*87**3,Niter))
...
axes[0,0].set_title(r'$\alpha=1$',fontsize=fs)
axes[0,1].set_title(r'$\alpha=2$',fontsize=fs)
axes[0,2].set_title(r'$\alpha=4$',fontsize=fs)
axes[0,3].set_title(r'$\alpha=8$',fontsize=fs)
...
fig.savefig('../plots/mean/mean_adaptativeNbins.pdf'.format(Niter),dpi=fig.dpi)
fig.savefig('../plots/mean/mean_adaptativeNbins.png'.format(Niter),dpi=fig.dpi)
