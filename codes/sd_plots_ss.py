...
for ir in range(len(nr)):
	...
	f.tight_layout()
	f.savefig('/home/fede/Proyectos/Multipoles/plots/smallscale/sd_vs_nran/sd_{}_ss.png'.format(ir),dpi=f.dpi)
	#plt.show()
	plt.close()
...
for Nran in [2*87**3,4*87**3,8*87**3,16*87**3]:
	...
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('/home/fede/Proyectos/Multipoles/plots/smallscale/sd_vs_r/s_vs_r_ss_{}.png'.format(Nran),dpi=f.dpi)
	#plt.show()
	plt.close()
