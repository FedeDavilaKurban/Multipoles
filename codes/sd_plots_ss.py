...
#ran_rs_2 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_ran_{}_smallscale.txt'.format(2*87**3))
...
#Glass
# g_1 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_glass_{}_smallscale.txt'.format(87**3))
# g_2 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_glass_{}_smallscale.txt'.format(2*87**3))
# g_4 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_glass_{}_smallscale.txt'.format(4*87**3))
# g_8 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_glass_{}_smallscale.txt'.format(8*87**3))
...
#zr_rs_1 = ascii.read('/home/fede/Proyectos/Multipoles/data/out/sd_xi/sd_zelrec_{}_smallscale.txt'.format(87**3))
...
for Nran in [87**3,2*87**3,4*87**3,8*87**3]:
	...
	f.subplots_adjust(hspace=0)
	f.tight_layout()
	f.savefig('/home/fede/Proyectos/Multipoles/plots/smallscale/sd_vs_r/s_vs_r_{}.png'.format(Nran),dpi=f.dpi)
	#plt.show()
	plt.close()
