...
if int(sys.argv[1]) == 1: glass_dir = 'glass/1x87/'
if int(sys.argv[1]) == 2: glass_dir = 'glass/2x87/'
if int(sys.argv[1]) == 4: glass_dir = 'glass/4x87/'
if int(sys.argv[1]) == 8: glass_dir = 'glass/8x87/'

files = sorted(os.listdir(glass_dir))
os.chdir(glass_dir)
...
rcat1 = BinaryCatalog(f1,dtype,header_size=4)
nran = rcat1.size
rcat2 = BinaryCatalog(f2,dtype,header_size=4)
...
wfile = 'xi_l_glass_{}_{}-{}.txt'.format(rcat1.size,i,i+1)
