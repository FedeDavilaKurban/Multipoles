...
#nr = 2.5+np.linspace(5.,152.,30)[:-1] #Scales
nr = np.linspace(5.,152.,30)[:-1]  / 0.695 #Scales
...
# plt.tight_layout()
# axes[0].legend(markerscale=1,ncol=3,loc='upper left')
...
plt.tight_layout()
axes[0].legend(markerscale=1,ncol=3)
