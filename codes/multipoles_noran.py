...
ascii.write(xi_l,'../data/xi_l_noran.txt',overwrite=True,names=['xi_0','xi_2','xi_4','xi_6'])
    

#Leo los xi_l (si no los calcule ya)
xi_l =  ascii.read('/home/fdavilakurban/Proyectos/HomDist/Multipoles/data/xi_l_noran.txt',names=['xi_0','xi_2','xi_4','xi_6']) 
