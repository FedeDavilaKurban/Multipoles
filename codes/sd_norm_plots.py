...
#for ir in range(1):
	...
	if ir!=1: ax1.tick_params(axis='y',which='both',left=True,labelleft=False)
	...
	if ir!=1: ax2.tick_params(axis='y',which='both',left=True,labelleft=False)
	...
	if ir!=1: ax3.tick_params(axis='y',which='both',left=True,labelleft=False)
...
for Nran in [2*87**3,4*87**3,8*87**3,16*87**3]:
	...
	ax1.set_ylim(.15,1.35)
	if Nran!=2*87**3: ax1.set_yticks([], [])
	if Nran!=2*87**3: ax1.tick_params(axis='y',which='both',left=True,labelleft=False)
	ax1.tick_params(axis='x',which='both',bottom=False,top=False,labelbottom=False)
	...
	if Nran!=2*87**3: ax2.tick_params(axis='y',which='both',left=True,labelleft=False)
	...
	if Nran!=2*87**3: ax3.tick_params(axis='y',which='both',left=True,labelleft=False)
